...
export default function PegtopLoader(): React.ReactElement {
  return (
    <div className="pegtop-loader-wrapper">
      ...
      <div className="pegtop-loader-caption">
        <span className="pegtop-loader-dot" />
        <span>Initializing Zyro AI...</span>
      </div>
    </div>
  )
}
