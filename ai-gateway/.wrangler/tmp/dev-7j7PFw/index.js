...
// .wrangler/tmp/bundle-vYhpfx/checked-fetch.js
...
var app = new Hono2();
var providers = [];
function initializeProviders(env) {
  ...
  providers = [
    ...
    },
    {
      ...
      status: "healthy",
      cooldownUntil: 0,
      enforcedModel: "llama-4-scout-17b-16e-instruct"
    },
    {
      name: "groq_llama_2",
      service: "llm",
    ...
    },
    {
      ...
      status: "healthy",
      cooldownUntil: 0,
      enforcedModel: "mistralai/mistral-small-3.1-24b-instruct:free"
    },
    {
      name: "nvidia_whisper",
      service: "stt",
      apiKey: env.NVIDIA_WHISPER_KEY,
      apiUrl: "https://ai.api.nvidia.com/v1/audio/transcriptions",
      activeRequests: 0,
      status: "healthy",
      cooldownUntil: 0,
      enforcedModel: "parakeet-ctc-1.1b-asr"
    },
    {
      name: "nvidia_llm",
      service: "llm",
      apiKey: env.NVIDIA_LLM_KEY,
...
__name(initializeProviders, "initializeProviders");
function getBestProvider(service) {
  const now = Date.now();
...
__name(getBestProvider, "getBestProvider");
async function forwardRequest(provider, content, method) {
  provider.activeRequests++;
  try {
    const headers = new Headers(content.headers);
    if (provider.name.includes("deepgram")) {
      headers.set("Authorization", `Token ${provider.apiKey}`);
    } else {
      headers.set("Authorization", `Bearer ${provider.apiKey}`);
    }
    let body = content.data;
    if (provider.enforcedModel) {
      if (content.type === "json") {
        ...
        const oldFormData = content.data;
    ...
    if (response.status === 429 || response.status >= 500) {
      ...
      provider.cooldownUntil = Date.now() + 3e4;
...
// node_modules/.pnpm/wrangler@4.74.0_@cloudflare+workers-types@4.20260317.1/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// node_modules/.pnpm/wrangler@4.74.0_@cloudflare+workers-types@4.20260317.1/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-vYhpfx/middleware-insertion-facade.js
...
// node_modules/.pnpm/wrangler@4.74.0_@cloudflare+workers-types@4.20260317.1/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-vYhpfx/middleware-loader.entry.ts
